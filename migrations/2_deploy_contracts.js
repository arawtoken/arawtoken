var ArawToken = artifacts.require("ArawToken.sol");
...
module.exports = function(deployer) {
  deployer.deploy(ArawToken, reservedTokensAddress, foundersTokensAddress, advisorsTokensAddress, arawWalletAddress).then(function(){
  	return deployer.deploy(PrivateSale, ArawToken.address);
  })
}